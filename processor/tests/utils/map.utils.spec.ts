...
describe('createMollieCreatePaymentParams', () => {
  ...
  //   const mollieCreatePaymentParams = createMollieCreatePaymentParams(CTPayment, extensionUrl, surchargeAmountInCent, cart);
  //   const mollieAmount = {
  ...
  //   const mollieCreatePaymentParams: PaymentCreateParams = createMollieCreatePaymentParams(CTPayment, extensionUrl, 0, cart);
  //   expect(mollieCreatePaymentParams).toEqual({
