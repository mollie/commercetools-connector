...
describe('checkPaymentMethodSpecificParameters', () => {
  ...
  it('should not throw any error or terminate the process if the payment method is blik and the currency code is PLN and the billing email is provided correctly', async () => {
    const CTPayment: Payment = {
      id: '5c8b0375-305a-4f19-ae8e-07806b101999',
      version: 1,
      createdAt: '2024-07-04T14:07:35.625Z',
